...
namespace Game
{
	...
	{
		// Token: 0x060007AF RID: 1967 RVA: 0x0002C2A4 File Offset: 0x0002A4A4
		public BestiaryScreen()
		{
			XElement node = ContentManager.Get<XElement>("Screens/BestiaryScreen", null);
			...
			this.m_creaturesList.ItemWidgetFactory = delegate(object item)
			{
				...
				XElement node2 = ContentManager.Get<XElement>("Widgets/BestiaryItem", null);
			...
			ListPanelWidget creaturesList = this.m_creaturesList;
			creaturesList.ItemClicked = (Action<object>)Delegate.Combine(creaturesList.ItemClicked, new Action<object>(delegate(object item)
			{
		...
		// Token: 0x060007B0 RID: 1968 RVA: 0x0002C73C File Offset: 0x0002A93C
		...
		// Token: 0x060007B1 RID: 1969 RVA: 0x0002C768 File Offset: 0x0002A968
		...
		// Token: 0x060007B2 RID: 1970 RVA: 0x0002C7B8 File Offset: 0x0002A9B8
		...
		{
			modelWidget.Model = ContentManager.Get<Model>(info.ModelName, null);
			modelWidget.TextureOverride = ContentManager.Get<Texture2D>(info.TextureOverride, null);
