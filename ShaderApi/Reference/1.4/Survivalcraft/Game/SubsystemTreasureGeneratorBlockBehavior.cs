...
namespace Game
{
	...
	public class SubsystemTreasureGeneratorBlockBehavior : SubsystemBlockBehavior
	{
		...
		// (get) Token: 0x06000D0B RID: 3339 RVA: 0x0005DD61 File Offset: 0x0005BF61
		...
		// Token: 0x06000D0C RID: 3340 RVA: 0x0005DD74 File Offset: 0x0005BF74
		public override void OnNeighborBlockChanged(int x, int y, int z, int neighborX, int neighborY, int neighborZ)
		{
			...
			ModsManager.HookAction("OnTreasureGenerate", delegate(ModLoader modLoader)
			{
				bool result;
				modLoader.OnTreasureGenerate(this.SubsystemTerrain, x, y, z, neighborX, neighborY, neighborZ, ref num, ref num2, out result);
				return result;
			});
			if (num != 0 && num2 > 0)
			{
		...
		// Token: 0x06000D0D RID: 3341 RVA: 0x0005DFFC File Offset: 0x0005C1FC
		...
		// Token: 0x06000D0E RID: 3342 RVA: 0x0005E018 File Offset: 0x0005C218
