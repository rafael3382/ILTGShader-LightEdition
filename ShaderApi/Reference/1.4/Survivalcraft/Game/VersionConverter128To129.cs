...
namespace Game
{
	...
	public class VersionConverter128To129 : VersionConverter
	{
		...
		// (get) Token: 0x060018CF RID: 6351 RVA: 0x000C1E1C File Offset: 0x000C001C
		...
		// (get) Token: 0x060018D0 RID: 6352 RVA: 0x000C1E23 File Offset: 0x000C0023
		...
		// Token: 0x060018D1 RID: 6353 RVA: 0x000C1E2C File Offset: 0x000C002C
		public override void ConvertProjectXml(XElement projectNode)
		{
			...
			foreach (XElement xelement13 in projectNode.Element("Entities").Elements())
			{
				...
				{
					predicate = (<>9__11 = ((XElement e) => inventoryNames.Contains(XmlUtils.GetAttributeValue<string>(e, "Name", string.Empty))));
				}
		...
		// Token: 0x060018D2 RID: 6354 RVA: 0x000C27F4 File Offset: 0x000C09F4
		...
		// Token: 0x060018D3 RID: 6355 RVA: 0x000C2804 File Offset: 0x000C0A04
		...
		// Token: 0x060018D4 RID: 6356 RVA: 0x000C2888 File Offset: 0x000C0A88
		...
		// Token: 0x060018D5 RID: 6357 RVA: 0x000C2AEC File Offset: 0x000C0CEC
		...
		// Token: 0x060018D6 RID: 6358 RVA: 0x000C2B24 File Offset: 0x000C0D24
