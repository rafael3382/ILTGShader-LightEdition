...
namespace Game
{
	...
	{
		// Token: 0x0600022D RID: 557 RVA: 0x0000E8AC File Offset: 0x0000CAAC
		public override void GenerateTerrainVertices(BlockGeometryGenerator generator, TerrainGeometry geometry, int value, int x, int y, int z)
		{
			...
			if (FireBlock.HasFireOnFace(data, 0))
			{
				...
				DynamicArray<int> indices = alphaTestSubsetsByFace[0].Indices;
			...
			if (FireBlock.HasFireOnFace(data, 1))
			{
				...
				DynamicArray<int> indices2 = alphaTestSubsetsByFace[1].Indices;
			...
			if (FireBlock.HasFireOnFace(data, 2))
			{
				...
				DynamicArray<int> indices3 = alphaTestSubsetsByFace[2].Indices;
			...
			DynamicArray<int> indices4 = alphaTestSubsetsByFace[3].Indices;
		...
		// Token: 0x0600022E RID: 558 RVA: 0x0000F118 File Offset: 0x0000D318
		public override void DrawBlock(PrimitivesRenderer3D primitivesRenderer, int value, Color color, float size, ref Matrix matrix, DrawBlockEnvironmentData environmentData)
		{
		}

		// Token: 0x0600022F RID: 559 RVA: 0x0000F11A File Offset: 0x0000D31A
		public override bool ShouldAvoid(int value)
		{
			return true;
		}

		// Token: 0x06000230 RID: 560 RVA: 0x0000F11D File Offset: 0x0000D31D
