...
namespace Game
{
	...
	public class TerrainContentsGenerator21 : ITerrainContentsGenerator
	{
		...
		// (get) Token: 0x06001795 RID: 6037 RVA: 0x000AF946 File Offset: 0x000ADB46
		...
		// Token: 0x06001796 RID: 6038 RVA: 0x000AF958 File Offset: 0x000ADB58
		static TerrainContentsGenerator21()
		{
			TerrainContentsGenerator21.CreateBrushes();
		}

		// Token: 0x06001797 RID: 6039 RVA: 0x000AFA14 File Offset: 0x000ADC14
		public TerrainContentsGenerator21(SubsystemTerrain subsystemTerrain)
		{
			...
			TerrainContentsGenerator21.OldRandom oldRandom = new TerrainContentsGenerator21.OldRandom(100 + this.m_seed);
			TerrainContentsGenerator21.Random random = new TerrainContentsGenerator21.Random(this.m_seed);
			if (string.IsNullOrEmpty(subsystemGameInfo.WorldSettings.OriginalSerializationVersion))
			{
				...
				TerrainContentsGenerator21.TGSurfaceMultiplier = 1f;
				this.TGWater = true;
				this.TGExtras = true;
			...
			this.TGTurbulenceTopOffset = 0f;
			this.TGTurbulencePower = 0.3f;
			TerrainContentsGenerator21.TGSurfaceMultiplier = 2f;
			this.TGWater = true;
			this.TGExtras = true;
			this.TGCavesAndPockets = true;
		}

		// Token: 0x06001798 RID: 6040 RVA: 0x000AFFA4 File Offset: 0x000AE1A4
		...
		// Token: 0x06001799 RID: 6041 RVA: 0x000B007E File Offset: 0x000AE27E
		...
		// Token: 0x0600179A RID: 6042 RVA: 0x000B0098 File Offset: 0x000AE298
		...
		// Token: 0x0600179B RID: 6043 RVA: 0x000B00B4 File Offset: 0x000AE2B4
		...
		// Token: 0x0600179C RID: 6044 RVA: 0x000B00DC File Offset: 0x000AE2DC
		...
		// Token: 0x0600179D RID: 6045 RVA: 0x000B0144 File Offset: 0x000AE344
		...
		// Token: 0x0600179E RID: 6046 RVA: 0x000B01E0 File Offset: 0x000AE3E0
		...
		// Token: 0x0600179F RID: 6047 RVA: 0x000B023C File Offset: 0x000AE43C
		...
		// Token: 0x060017A0 RID: 6048 RVA: 0x000B0548 File Offset: 0x000AE748
		...
		// Token: 0x060017A1 RID: 6049 RVA: 0x000B0630 File Offset: 0x000AE830
		...
		// Token: 0x060017A2 RID: 6050 RVA: 0x000B0718 File Offset: 0x000AE918
		...
		// Token: 0x060017A3 RID: 6051 RVA: 0x000B075C File Offset: 0x000AE95C
		...
		// Token: 0x060017A4 RID: 6052 RVA: 0x000B07A0 File Offset: 0x000AE9A0
		...
		// Token: 0x060017A5 RID: 6053 RVA: 0x000B08B4 File Offset: 0x000AEAB4
		...
		// Token: 0x060017A6 RID: 6054 RVA: 0x000B0924 File Offset: 0x000AEB24
		public void GenerateTerrain(TerrainChunk chunk, int x1, int z1, int x2, int z2)
		{
			...
			TerrainContentsGenerator21.Grid2d grid2d = new TerrainContentsGenerator21.Grid2d(num, num2);
			TerrainContentsGenerator21.Grid2d grid2d2 = new TerrainContentsGenerator21.Grid2d(num, num2);
			...
			TerrainContentsGenerator21.Grid3d grid3d = new TerrainContentsGenerator21.Grid3d(num / 4 + 1, 33, num2 / 4 + 1);
		...
		// Token: 0x060017A7 RID: 6055 RVA: 0x000B0DA8 File Offset: 0x000AEFA8
		public void GenerateSurface(TerrainChunk chunk)
		{
			Terrain terrain = this.m_subsystemTerrain.Terrain;
			TerrainContentsGenerator21.Random random = new TerrainContentsGenerator21.Random(this.m_seed + chunk.Coords.X + 101 * chunk.Coords.Y);
			for (int i = 0; i < 16; i++)
			{
				for (int j = 0; j < 16; j++)
				{
					...
					while (k >= 0)
					{
						...
						if (!BlocksManager.Blocks[num4].IsTransparent_(cellValueFast))
						{
							...
							float f = MathUtils.Saturate(MathUtils.Saturate((num5 - 0.9f) / 0.1f) - MathUtils.Saturate(((float)humidity - 3f) / 12f) + TerrainContentsGenerator21.TGSurfaceMultiplier * MathUtils.Saturate(((float)k - 85f) * 0.05f));
		...
		// Token: 0x060017A8 RID: 6056 RVA: 0x000B0FF4 File Offset: 0x000AF1F4
		public void GenerateMinerals(TerrainChunk chunk)
		{
			...
			for (int i = x - 1; i <= x + 1; i++)
			{
				...
				{
					TerrainContentsGenerator21.Random random = new TerrainContentsGenerator21.Random(this.m_seed + i + 119 * j);
					...
					for (int l = 0; l < num3; l++)
					{
						...
						TerrainContentsGenerator21.m_coalBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_coalBrushes.Count - 1)].PaintFastSelective(chunk, x2, y2, z, 3);
					}
					...
					for (int m = 0; m < num4; m++)
					{
						...
						TerrainContentsGenerator21.m_copperBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_copperBrushes.Count - 1)].PaintFastSelective(chunk, x3, y3, z2, 3);
					}
					...
					for (int n = 0; n < num5; n++)
					{
						...
						TerrainContentsGenerator21.m_ironBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_ironBrushes.Count - 1)].PaintFastSelective(chunk, x4, y4, z3, 67);
					}
					...
					for (int num7 = 0; num7 < num6; num7++)
					{
						...
						TerrainContentsGenerator21.m_saltpeterBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_saltpeterBrushes.Count - 1)].PaintFastSelective(chunk, x5, y5, z4, 4);
					}
					...
					for (int num9 = 0; num9 < num8; num9++)
					{
						...
						TerrainContentsGenerator21.m_sulphurBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_sulphurBrushes.Count - 1)].PaintFastSelective(chunk, x6, y6, z5, 67);
					}
					...
					for (int num11 = 0; num11 < num10; num11++)
					{
						...
						TerrainContentsGenerator21.m_diamondBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_diamondBrushes.Count - 1)].PaintFastSelective(chunk, x7, y7, z6, 67);
					}
					...
					for (int num13 = 0; num13 < num12; num13++)
					{
						...
						TerrainContentsGenerator21.m_germaniumBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_germaniumBrushes.Count - 1)].PaintFastSelective(chunk, x8, y8, z7, 67);
					}
				}
			}
		}

		// Token: 0x060017A9 RID: 6057 RVA: 0x000B1504 File Offset: 0x000AF704
		public void GeneratePockets(TerrainChunk chunk)
		{
			...
			for (int i = -1; i <= 1; i++)
			{
				for (int j = -1; j <= 1; j++)
				{
					...
					TerrainContentsGenerator21.Random random = new TerrainContentsGenerator21.Random(this.m_seed + num + 71 * num2);
					...
					for (int l = 0; l < 3; l++)
					{
						...
						TerrainContentsGenerator21.m_dirtPocketBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_dirtPocketBrushes.Count - 1)].PaintFastSelective(chunk, x, y, z, 3);
					}
					for (int m = 0; m < 10; m++)
					{
						...
						TerrainContentsGenerator21.m_gravelPocketBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_gravelPocketBrushes.Count - 1)].PaintFastSelective(chunk, x2, y2, z2, 3);
					}
					for (int n = 0; n < 2; n++)
					{
						...
						TerrainContentsGenerator21.m_limestonePocketBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_limestonePocketBrushes.Count - 1)].PaintFastSelective(chunk, x3, y3, z3, 3);
					}
					for (int num5 = 0; num5 < 1; num5++)
					{
						...
						TerrainContentsGenerator21.m_clayPocketBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_clayPocketBrushes.Count - 1)].PaintFastSelective(chunk, x4, y4, z4, 3);
					}
					for (int num6 = 0; num6 < 6; num6++)
					{
						...
						TerrainContentsGenerator21.m_sandPocketBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_sandPocketBrushes.Count - 1)].PaintFastSelective(chunk, x5, y5, z5, 4);
					}
					for (int num7 = 0; num7 < 4; num7++)
					{
						...
						TerrainContentsGenerator21.m_basaltPocketBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_basaltPocketBrushes.Count - 1)].PaintFastSelective(chunk, x6, y6, z6, 4);
					}
					for (int num8 = 0; num8 < 3; num8++)
					{
						...
						TerrainContentsGenerator21.m_basaltPocketBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_basaltPocketBrushes.Count - 1)].PaintFastSelective(chunk, x7, y7, z7, 3);
					}
					for (int num9 = 0; num9 < 6; num9++)
					{
						...
						TerrainContentsGenerator21.m_granitePocketBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_granitePocketBrushes.Count - 1)].PaintFastSelective(chunk, x8, y8, z8, 67);
					}
					if (random.Bool(0.02f + 0.01f * num4))
					{
						...
						for (int num14 = 0; num14 < num13; num14++)
						{
							...
							TerrainContentsGenerator21.m_waterPocketBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_waterPocketBrushes.Count - 1)].PaintFast(chunk, num10 + num15, num11 + num16, num12 + num17);
						}
					}
					if (random.Bool(0.06f + 0.05f * num4))
					{
						...
						for (int num22 = 0; num22 < num21; num22++)
						{
							...
							TerrainContentsGenerator21.m_magmaPocketBrushes[random.UniformInt(0, TerrainContentsGenerator21.m_magmaPocketBrushes.Count - 1)].PaintFast(chunk, num18 + num23, num19 + num24, num20 + num25);
						}
					}
				}
			}
		...
		// Token: 0x060017AA RID: 6058 RVA: 0x000B1A6C File Offset: 0x000AFC6C
		public void GenerateCaves(TerrainChunk chunk)
		{
			...
			List<TerrainContentsGenerator21.CavePoint> list = new List<TerrainContentsGenerator21.CavePoint>();
			int x = chunk.Coords.X;
			int y = chunk.Coords.Y;
			for (int i = x - 2; i <= x + 2; i++)
			{
				...
				{
					list.Clear();
					TerrainContentsGenerator21.Random random = new TerrainContentsGenerator21.Random(this.m_seed + i + 9973 * j);
					...
					if (random.Bool(probability))
					{
						...
						if (vector.Y > -0.6f)
						{
							list.Add(new TerrainContentsGenerator21.CavePoint
							{
								Position = position,
								Direction = vector,
								BrushType = 0,
						...
						while (k < list.Count)
						{
							TerrainContentsGenerator21.CavePoint cavePoint = list[k];
							List<TerrainBrush> list2 = TerrainContentsGenerator21.m_caveBrushesByType[cavePoint.BrushType];
							...
							if (cavePoint.StepsTaken > 20 && random.Bool(0.05f))
							{
								...
								cavePoint.BrushType = MathUtils.Min(cavePoint.BrushType + 2, TerrainContentsGenerator21.m_caveBrushesByType.Count - 1);
							}
							...
							{
								cavePoint.BrushType = (int)(MathUtils.Pow(random.UniformFloat(0f, 0.999f), 7f) * (float)TerrainContentsGenerator21.m_caveBrushesByType.Count);
							}
							if (random.Bool(0.06f) && list.Count < 12 && cavePoint.StepsTaken > 20 && cavePoint.Position.Y < 58f)
							{
								list.Add(new TerrainContentsGenerator21.CavePoint
								{
									...
									BrushType = (int)(MathUtils.Pow(random.UniformFloat(0f, 0.999f), 7f) * (float)TerrainContentsGenerator21.m_caveBrushesByType.Count),
		...
		// Token: 0x060017AB RID: 6059 RVA: 0x000B20E8 File Offset: 0x000B02E8
				...
				for (int j = y2; j <= y2; j++)
				{
						...
						if (num10 >= 66)
						{
							...
							if (cellContentsFast == 2 || cellContentsFast == 8)
							{
								...
								for (int k = 0; k < num11; k++)
								{
									...
									int cellValueFast = terrain.GetCellValueFast(num12, num10, num13);
									int cellValueFast2 = terrain.GetCellValueFast(num12, num10 - 1, num13);
									if (BlocksManager.Blocks[Terrain.ExtractContents(cellValueFast)].IsCollidable_(cellValueFast))
									{
										flag = false;
										break;
									}
									if (BlocksManager.Blocks[Terrain.ExtractContents(cellValueFast2)].IsCollidable_(cellValueFast2))
									{
								...
								if (flag && flag2 && flag3)
								{
									...
									if (treeType != null)
									{
										...
										for (int l = 0; l < num11; l++)
										{
											...
											if (l > num11 / 2)
											{
												int cellValueFast3 = terrain.GetCellValueFast(num14 + point2.X, num10, num15 + point2.Z);
												int cellValueFast4 = terrain.GetCellValueFast(num14 + point2.X, num10, num15 + point2.Z);
												int cellValueFast5 = terrain.GetCellValueFast(num14 - point2.X, num10, num15 - point2.Z);
												int cellValueFast6 = terrain.GetCellValueFast(num14 - point2.X, num10, num15 - point2.Z);
												int cellValueFast7 = terrain.GetCellValueFast(num14, num10 + 1, num15);
												if (random.Bool(0.3f) && !BlocksManager.Blocks[Terrain.ExtractContents(cellValueFast3)].IsCollidable_(cellValueFast3))
												{
													terrain.SetCellValueFast(num14 + point2.X, num10, num15 + point2.Z, treeLeavesValue);
												}
												if (random.Bool(0.05f) && !BlocksManager.Blocks[Terrain.ExtractContents(cellValueFast4)].IsCollidable_(cellValueFast4))
												{
													terrain.SetCellValueFast(num14 + point2.X, num10, num15 + point2.Z, value);
												}
												if (random.Bool(0.3f) && !BlocksManager.Blocks[Terrain.ExtractContents(cellValueFast5)].IsCollidable_(cellValueFast5))
												{
													terrain.SetCellValueFast(num14 - point2.X, num10, num15 - point2.Z, treeLeavesValue);
												}
												if (random.Bool(0.05f) && !BlocksManager.Blocks[Terrain.ExtractContents(cellValueFast6)].IsCollidable_(cellValueFast6))
												{
													terrain.SetCellValueFast(num14 - point2.X, num10, num15 - point2.Z, value);
												}
												if (random.Bool(0.1f) && !BlocksManager.Blocks[Terrain.ExtractContents(cellValueFast7)].IsCollidable_(cellValueFast7))
												{
					...
					while (num18 < 32 && num17 < num16)
					{
						...
						if (num21 >= 66)
						{
							...
							{
								num21++;
								int cellValueFast8 = terrain.GetCellValueFast(num19 + 1, num21, num20);
								int cellValueFast9 = terrain.GetCellValueFast(num19 - 1, num21, num20);
								int cellValueFast10 = terrain.GetCellValueFast(num19, num21, num20 + 1);
								int cellValueFast11 = terrain.GetCellValueFast(num19, num21, num20 - 1);
								if (!BlocksManager.Blocks[Terrain.ExtractContents(cellValueFast8)].IsCollidable_(cellValueFast8) && !BlocksManager.Blocks[Terrain.ExtractContents(cellValueFast9)].IsCollidable_(cellValueFast9) && !BlocksManager.Blocks[Terrain.ExtractContents(cellValueFast10)].IsCollidable_(cellValueFast10) && !BlocksManager.Blocks[Terrain.ExtractContents(cellValueFast11)].IsCollidable_(cellValueFast11))
								{
		...
		// Token: 0x060017AC RID: 6060 RVA: 0x000B2860 File Offset: 0x000B0A60
		...
		// Token: 0x060017AD RID: 6061 RVA: 0x000B2904 File Offset: 0x000B0B04
		...
		// Token: 0x060017AE RID: 6062 RVA: 0x000B29F0 File Offset: 0x000B0BF0
		public void GenerateBottomSuckers(TerrainChunk chunk)
		{
			...
			TerrainContentsGenerator21.Random random = new TerrainContentsGenerator21.Random(this.m_seed + chunk.Coords.X + 2210 * chunk.Coords.Y);
			for (int i = 0; i < 16; i++)
			{
				for (int j = 0; j < 16; j++)
				{
		...
		// Token: 0x060017AF RID: 6063 RVA: 0x000B2C84 File Offset: 0x000B0E84
		public void GenerateCacti(TerrainChunk chunk)
		{
			...
			int x = chunk.Coords.X;
			int y = chunk.Coords.Y;
			TerrainContentsGenerator21.Random random = new TerrainContentsGenerator21.Random(this.m_seed + x + 1991 * y);
			if (!random.Bool(0.5f))
			{
				return;
			}
		...
		// Token: 0x060017B0 RID: 6064 RVA: 0x000B2E08 File Offset: 0x000B1008
		public void GeneratePumpkins(TerrainChunk chunk)
		{
			...
			int x = chunk.Coords.X;
			int y = chunk.Coords.Y;
			TerrainContentsGenerator21.Random random = new TerrainContentsGenerator21.Random(this.m_seed + x + 1495 * y);
			if (!random.Bool(0.2f))
			{
				return;
			}
		...
		// Token: 0x060017B1 RID: 6065 RVA: 0x000B2F50 File Offset: 0x000B1150
		public void GenerateKelp(TerrainChunk chunk)
		{
			...
			int x = chunk.Coords.X;
			int y = chunk.Coords.Y;
			TerrainContentsGenerator21.Random random = new TerrainContentsGenerator21.Random(0);
			float num = 0f;
			for (int i = 0; i < 9; i++)
			{
				int num2 = i % 3 - 1;
		...
		// Token: 0x060017B2 RID: 6066 RVA: 0x000B3194 File Offset: 0x000B1394
		public void GenerateSeagrass(TerrainChunk chunk)
		{
			...
			int x = chunk.Coords.X;
			int y = chunk.Coords.Y;
			TerrainContentsGenerator21.Random random = new TerrainContentsGenerator21.Random(this.m_seed + x + 378 * y);
			for (int i = 0; i < 6; i++)
			{
		...
		// Token: 0x060017B3 RID: 6067 RVA: 0x000B3338 File Offset: 0x000B1538
		public void GenerateIvy(TerrainChunk chunk)
		{
			...
			TerrainContentsGenerator21.Random random = new TerrainContentsGenerator21.Random(this.m_seed + chunk.Coords.X + 2191 * chunk.Coords.Y);
		...
		// Token: 0x060017B4 RID: 6068 RVA: 0x000B35A4 File Offset: 0x000B17A4
		public void GenerateTraps(TerrainChunk chunk)
		{
			...
			int y = chunk.Coords.Y;
			Terrain terrain = this.m_subsystemTerrain.Terrain;
			TerrainContentsGenerator21.Random random = new TerrainContentsGenerator21.Random(this.m_seed + x + 2113 * y);
		...
		// Token: 0x060017B5 RID: 6069 RVA: 0x000B38B8 File Offset: 0x000B1AB8
		public void GenerateGraves(TerrainChunk chunk)
		{
			...
			int x = chunk.Coords.X;
			int y = chunk.Coords.Y;
			TerrainContentsGenerator21.Random random = new TerrainContentsGenerator21.Random((int)MathUtils.Hash((uint)(this.m_seed + x + 10323 * y)));
						...
						while (k < 4)
						{
							...
							for (int l = num10; l <= num11; l++)
							{
								for (int m = num7 - 2; m <= num7 + 2; m++)
								{
									...
									while (n <= num13)
									{
										int cellValueFast = chunk.GetCellValueFast(l, m, n);
		...
		// Token: 0x060017B6 RID: 6070 RVA: 0x000B3FA0 File Offset: 0x000B21A0
		...
		// Token: 0x060017B7 RID: 6071 RVA: 0x000B4118 File Offset: 0x000B2318
		...
		// Token: 0x060017B8 RID: 6072 RVA: 0x000B4194 File Offset: 0x000B2394
		...
		// Token: 0x060017B9 RID: 6073 RVA: 0x000B4238 File Offset: 0x000B2438
		public static void CreateBrushes()
		{
			TerrainContentsGenerator21.Random random = new TerrainContentsGenerator21.Random(17);
			for (int i = 0; i < 16; i++)
			{
				...
				TerrainContentsGenerator21.m_coalBrushes.Add(terrainBrush);
			}
			for (int l = 0; l < 16; l++)
			{
				...
				TerrainContentsGenerator21.m_ironBrushes.Add(terrainBrush2);
			}
			for (int num5 = 0; num5 < 16; num5++)
			{
				...
				TerrainContentsGenerator21.m_copperBrushes.Add(terrainBrush3);
			}
			for (int num10 = 0; num10 < 16; num10++)
			{
				...
				TerrainContentsGenerator21.m_saltpeterBrushes.Add(terrainBrush4);
			}
			for (int num15 = 0; num15 < 16; num15++)
			{
				...
				TerrainContentsGenerator21.m_sulphurBrushes.Add(terrainBrush5);
			}
			for (int num20 = 0; num20 < 16; num20++)
			{
				...
				TerrainContentsGenerator21.m_diamondBrushes.Add(terrainBrush6);
			}
			for (int num25 = 0; num25 < 16; num25++)
			{
				...
				TerrainContentsGenerator21.m_germaniumBrushes.Add(terrainBrush7);
			}
			for (int num30 = 0; num30 < 16; num30++)
			{
				...
				TerrainContentsGenerator21.m_dirtPocketBrushes.Add(terrainBrush8);
			}
			for (int num35 = 0; num35 < 16; num35++)
			{
				...
				TerrainContentsGenerator21.m_gravelPocketBrushes.Add(terrainBrush9);
			}
			for (int num40 = 0; num40 < 16; num40++)
			{
				...
				TerrainContentsGenerator21.m_limestonePocketBrushes.Add(terrainBrush10);
			}
			for (int num45 = 0; num45 < 16; num45++)
			{
				...
				TerrainContentsGenerator21.m_clayPocketBrushes.Add(terrainBrush11);
			}
			for (int num50 = 0; num50 < 16; num50++)
			{
				...
				TerrainContentsGenerator21.m_sandPocketBrushes.Add(terrainBrush12);
			}
			for (int num55 = 0; num55 < 16; num55++)
			{
				...
				TerrainContentsGenerator21.m_basaltPocketBrushes.Add(terrainBrush13);
			}
			for (int num60 = 0; num60 < 16; num60++)
			{
				...
				TerrainContentsGenerator21.m_granitePocketBrushes.Add(terrainBrush14);
			}
			int[] array = new int[]
			{
				4,
			...
			for (int num65 = 0; num65 < 4 * array.Length; num65++)
			{
				...
				TerrainContentsGenerator21.m_waterPocketBrushes.Add(terrainBrush15);
			}
			int[] array2 = new int[]
			{
				8,
			...
			for (int num73 = 0; num73 < 4 * array2.Length; num73++)
			{
				...
				TerrainContentsGenerator21.m_magmaPocketBrushes.Add(terrainBrush16);
			}
			for (int num82 = 0; num82 < 7; num82++)
			{
				TerrainContentsGenerator21.m_caveBrushesByType.Add(new List<TerrainBrush>());
				for (int num83 = 0; num83 < 3; num83++)
				{
					...
					TerrainContentsGenerator21.m_caveBrushesByType[num82].Add(terrainBrush17);
				}
			}
		}
		...
		public class Random
		{
			// Token: 0x0600224E RID: 8782 RVA: 0x000EC37B File Offset: 0x000EA57B
			public Random() : this(997 * TerrainContentsGenerator21.Random.m_counter++)
			{
			}

			// Token: 0x0600224F RID: 8783 RVA: 0x000EC396 File Offset: 0x000EA596
			public Random(int seed)
			{
				this.Reset(seed);
			}

			// Token: 0x06002250 RID: 8784 RVA: 0x000EC3A5 File Offset: 0x000EA5A5
			public void Reset(int seed)
			{
				this.m_seed = (ulong)((long)seed ^ 25214903917L);
			}

			// Token: 0x06002251 RID: 8785 RVA: 0x000EC3B9 File Offset: 0x000EA5B9
			public int Sign()
			{
				if (this.Int() % 2 != 0)
				{
			...
			// Token: 0x06002252 RID: 8786 RVA: 0x000EC3C8 File Offset: 0x000EA5C8
			public bool Bool()
			{
				return this.Int() % 2 == 0;
			}

			// Token: 0x06002253 RID: 8787 RVA: 0x000EC3D5 File Offset: 0x000EA5D5
			public bool Bool(float probability)
			{
				return (float)this.Int() / 2.147484E+09f < probability;
			}

			// Token: 0x06002254 RID: 8788 RVA: 0x000EC3E7 File Offset: 0x000EA5E7
			public int Int()
			{
			...
			// Token: 0x06002255 RID: 8789 RVA: 0x000EC417 File Offset: 0x000EA617
			public int UniformInt(int min, int max)
			{
				return (int)((long)min + (long)this.Int() * (long)(max - min + 1) / (long)((ulong)int.MinValue));
			}

			// Token: 0x06002256 RID: 8790 RVA: 0x000EC434 File Offset: 0x000EA634
			...
			// Token: 0x06002257 RID: 8791 RVA: 0x000EC458 File Offset: 0x000EA658
			...
			// Token: 0x06002258 RID: 8792 RVA: 0x000EC568 File Offset: 0x000EA768
			...
			// Token: 0x06002259 RID: 8793 RVA: 0x000EC5C0 File Offset: 0x000EA7C0
			...
			// Token: 0x0600225A RID: 8794 RVA: 0x000EC61C File Offset: 0x000EA81C
			...
			// Token: 0x0600225B RID: 8795 RVA: 0x000EC684 File Offset: 0x000EA884
			...
			public static readonly TerrainContentsGenerator21.Random GlobalRandom = new TerrainContentsGenerator21.Random(0);
		}

		// Token: 0x02000546 RID: 1350
		public class OldRandom
		{
			// Token: 0x0600225D RID: 8797 RVA: 0x000EC708 File Offset: 0x000EA908
			public OldRandom()
			{
				this.m_random = new TerrainContentsGenerator21.OldRandom.InternalRandom(997 * TerrainContentsGenerator21.OldRandom.m_seed++);
			}

			// Token: 0x0600225E RID: 8798 RVA: 0x000EC72E File Offset: 0x000EA92E
			public OldRandom(int seed)
			{
				this.m_random = new TerrainContentsGenerator21.OldRandom.InternalRandom(seed);
			}

			// Token: 0x0600225F RID: 8799 RVA: 0x000EC742 File Offset: 0x000EA942
			public int Sign()
			{
			...
			// Token: 0x06002260 RID: 8800 RVA: 0x000EC756 File Offset: 0x000EA956
			public bool Bool()
			{
				return this.m_random.Next() % 2 == 0;
			}

			// Token: 0x06002261 RID: 8801 RVA: 0x000EC768 File Offset: 0x000EA968
			public int UniformInt(int min, int max)
			{
				return this.m_random.Next(min, max + 1);
			}

			// Token: 0x06002262 RID: 8802 RVA: 0x000EC779 File Offset: 0x000EA979
			public float UniformFloat(float min, float max)
			{
				return (float)this.m_random.NextDouble() * (max - min) + min;
			}

			// Token: 0x06002263 RID: 8803 RVA: 0x000EC790 File Offset: 0x000EA990
			public float NormalFloat(float mean, float stddev)
			{
				float num = this.UniformFloat(0f, 1f);
				if ((double)num < 0.5)
			...
			// Token: 0x06002264 RID: 8804 RVA: 0x000EC89E File Offset: 0x000EAA9E
			...
			// Token: 0x06002265 RID: 8805 RVA: 0x000EC8D0 File Offset: 0x000EAAD0
			...
			// Token: 0x06002266 RID: 8806 RVA: 0x000EC90C File Offset: 0x000EAB0C
			...
			// Token: 0x06002267 RID: 8807 RVA: 0x000EC95C File Offset: 0x000EAB5C
			...
			public TerrainContentsGenerator21.OldRandom.InternalRandom m_random;

			// Token: 0x04001905 RID: 6405
			public static int m_seed = (int)Stopwatch.GetTimestamp();

			// Token: 0x04001906 RID: 6406
			public static readonly TerrainContentsGenerator21.OldRandom GlobalRandom = new TerrainContentsGenerator21.OldRandom(0);

			// Token: 0x020005A6 RID: 1446
			public class InternalRandom
			{
				// Token: 0x06002368 RID: 9064 RVA: 0x000EFC88 File Offset: 0x000EDE88
				...
				// Token: 0x06002369 RID: 9065 RVA: 0x000EFD80 File Offset: 0x000EDF80
				...
				// Token: 0x0600236A RID: 9066 RVA: 0x000EFDB8 File Offset: 0x000EDFB8
				...
				// Token: 0x0600236B RID: 9067 RVA: 0x000EFE2B File Offset: 0x000EE02B
				public int Next()
				{
					return this.InternalSample();
				}

				// Token: 0x0600236C RID: 9068 RVA: 0x000EFE33 File Offset: 0x000EE033
				...
				// Token: 0x0600236D RID: 9069 RVA: 0x000EFE50 File Offset: 0x000EE050
				...
				// Token: 0x0600236E RID: 9070 RVA: 0x000EFE94 File Offset: 0x000EE094
				...
				// Token: 0x0600236F RID: 9071 RVA: 0x000EFECD File Offset: 0x000EE0CD
				public double NextDouble()
				{
					return this.Sample();
				}

				// Token: 0x06002370 RID: 9072 RVA: 0x000EFED5 File Offset: 0x000EE0D5
		...
		public class Grid2d
		{
			...
			// (get) Token: 0x0600226A RID: 8810 RVA: 0x000EC9D0 File Offset: 0x000EABD0
			public int SizeX
			{
				get
				{
			...
			// (get) Token: 0x0600226B RID: 8811 RVA: 0x000EC9D8 File Offset: 0x000EABD8
			public int SizeY
			{
				get
				{
			...
			// Token: 0x0600226C RID: 8812 RVA: 0x000EC9E0 File Offset: 0x000EABE0
			...
			// Token: 0x0600226D RID: 8813 RVA: 0x000ECA0E File Offset: 0x000EAC0E
			public float Get(int x, int y)
			{
				return this.m_data[x + y * this.m_sizeX];
			}

			// Token: 0x0600226E RID: 8814 RVA: 0x000ECA21 File Offset: 0x000EAC21
			public void Set(int x, int y, float value)
			{
				this.m_data[x + y * this.m_sizeX] = value;
			}

			// Token: 0x0600226F RID: 8815 RVA: 0x000ECA38 File Offset: 0x000EAC38
		...
		public class Grid3d
		{
			...
			// (get) Token: 0x06002270 RID: 8816 RVA: 0x000ECADA File Offset: 0x000EACDA
			public int SizeX
			{
				get
				{
			...
			// (get) Token: 0x06002271 RID: 8817 RVA: 0x000ECAE2 File Offset: 0x000EACE2
			public int SizeY
			{
				get
				{
			...
			// (get) Token: 0x06002272 RID: 8818 RVA: 0x000ECAEA File Offset: 0x000EACEA
			public int SizeZ
			{
				get
				{
			...
			// Token: 0x06002273 RID: 8819 RVA: 0x000ECAF4 File Offset: 0x000EACF4
			...
			// Token: 0x06002274 RID: 8820 RVA: 0x000ECB50 File Offset: 0x000EAD50
			...
			// Token: 0x06002275 RID: 8821 RVA: 0x000ECC09 File Offset: 0x000EAE09
			public float Get(int x, int y, int z)
			{
				return this.m_data[x + y * this.m_sizeX + z * this.m_sizeXY];
			}

			// Token: 0x06002276 RID: 8822 RVA: 0x000ECC25 File Offset: 0x000EAE25
			public void Set(int x, int y, int z, float value)
			{
				this.m_data[x + y * this.m_sizeX + z * this.m_sizeXY] = value;
			}

			// Token: 0x06002277 RID: 8823 RVA: 0x000ECC44 File Offset: 0x000EAE44
