...
namespace Game
{
	...
	{
		// Token: 0x06000680 RID: 1664 RVA: 0x000253C0 File Offset: 0x000235C0
		...
		// Token: 0x06000684 RID: 1668 RVA: 0x00025764 File Offset: 0x00023964
		...
		// Token: 0x06000685 RID: 1669 RVA: 0x000258E4 File Offset: 0x00023AE4
		...
		// Token: 0x06000686 RID: 1670 RVA: 0x000259E0 File Offset: 0x00023BE0
		...
		// Token: 0x06000687 RID: 1671 RVA: 0x00025A84 File Offset: 0x00023C84
		...
		// Token: 0x06000688 RID: 1672 RVA: 0x00025C27 File Offset: 0x00023E27
		...
		// Token: 0x06000689 RID: 1673 RVA: 0x00025C64 File Offset: 0x00023E64
		public static TerrainBrush CreateTreeBrush(Game.Random random, int woodIndex, int leavesIndex, int height, int branchesCount, Func<int, float> leavesProbabilityByHeight, Func<int, float> branchesLengthByHeight)
		{
			...
			for (int i = 0; i < branchesCount; i++)
			{
				...
				terrainBrush.AddRay(x, num, z, x2, y, z2, 1, 1, 1, delegate(int? v)
				{
					if (v == null)
					{
						...
						for (int m = 1; m <= point2.Y + 1; m++)
						{
							...
							if (random.Float(0f, 1f) < num2 && terrainBrush.GetValue(k, m, l) == null)
							{
								if (terrainBrush.CountNonDiagonalNeighbors(k, m, l, leavesIndex) == 0)
								{
									...
									if ((handler = <>9__1) == null)
									{
										handler = (<>9__1 = delegate(int? v)
										{
		...
		// Token: 0x0600068A RID: 1674 RVA: 0x00025F30 File Offset: 0x00024130
		public static TerrainBrush CreateMimosaBrush(Game.Random random, float size)
		{
			...
			float num = random.Float(0f, 6.28318548f);
			for (int i = 0; i < 3; i++)
			{
