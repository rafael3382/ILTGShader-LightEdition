...
namespace Game
{
	...
	public class OrbitCamera : BasePerspectiveCamera
	{
		...
		// (get) Token: 0x060015D6 RID: 5590 RVA: 0x000A4594 File Offset: 0x000A2794
		...
		// (get) Token: 0x060015D7 RID: 5591 RVA: 0x000A4597 File Offset: 0x000A2797
		...
		// Token: 0x060015D8 RID: 5592 RVA: 0x000A459A File Offset: 0x000A279A
		public OrbitCamera(GameWidget gameWidget) : base(gameWidget)
		{
		}

		// Token: 0x060015D9 RID: 5593 RVA: 0x000A45C8 File Offset: 0x000A27C8
		public override void Activate(Camera previousCamera)
		{
			base.SetupPerspectiveCamera(previousCamera.ViewPosition, previousCamera.ViewDirection, previousCamera.ViewUp);
		}

		// Token: 0x060015DA RID: 5594 RVA: 0x000A45E4 File Offset: 0x000A27E4
		public override void Update(float dt)
		{
			...
			for (int i = 0; i <= 0; i++)
			{
				for (int j = 0; j <= 0; j++)
				{
					...
					TerrainRaycastResult? terrainRaycastResult = base.GameWidget.SubsystemGameWidgets.SubsystemTerrain.Raycast(vector5, end, false, true, (int value, float distance) => !BlocksManager.Blocks[Terrain.ExtractContents(value)].IsTransparent_(value));
