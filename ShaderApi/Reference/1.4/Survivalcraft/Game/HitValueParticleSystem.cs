...
namespace Game
{
	...
	{
		// Token: 0x06001522 RID: 5410 RVA: 0x000A1144 File Offset: 0x0009F344
		...
		// Token: 0x06001523 RID: 5411 RVA: 0x000A11D4 File Offset: 0x0009F3D4
		...
		// Token: 0x06001524 RID: 5412 RVA: 0x000A12D4 File Offset: 0x0009F4D4
			...
			for (int i = 0; i < base.Particles.Length; i++)
			{
				...
				if (particle.IsActive)
				{
					...
					if (num4 > 0f)
					{
						...
						this.m_batch.QueueText(particle.Text, particle.Position, vector * s, v * s, color, TextAnchor.HorizontalCenter | TextAnchor.VerticalCenter, Vector2.Zero);
					}
				}
			}
		}
