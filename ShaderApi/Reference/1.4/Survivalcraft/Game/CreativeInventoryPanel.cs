...
namespace Game
{
	...
	{
		// Token: 0x060013EB RID: 5099 RVA: 0x00094D48 File Offset: 0x00092F48
		public CreativeInventoryPanel(CreativeInventoryWidget creativeInventoryWidget)
		{
			...
			XElement node = ContentManager.Get<XElement>("Widgets/CreativeInventoryPanel", null);
		...
		// Token: 0x060013EC RID: 5100 RVA: 0x00094E24 File Offset: 0x00093024
