...
namespace Game
{
	...
	public static class ScreenCaptureManager
	{
		...
		// Token: 0x06000858 RID: 2136 RVA: 0x000329B8 File Offset: 0x00030BB8
		...
		// Token: 0x06000859 RID: 2137 RVA: 0x000329D4 File Offset: 0x00030BD4
		public static void Capture(int width, int height, string filename)
		{
			if (GameManager.Project != null)
			{
				using (RenderTarget2D renderTarget2D = new RenderTarget2D(width, height, 1, ColorFormat.Rgba8888, DepthFormat.Depth24Stencil8))
				{
					...
					try
					{
						...
						if (SettingsManager.ShowLogoInScreenshots)
						{
							...
							Texture2D texture2D = ContentManager.Get<Texture2D>("Textures/Gui/ScreenCaptureOverlay", null);
				...
				ModsManager.HookAction("OnCapture", delegate(ModLoader loader)
				{
					loader.OnCapture();
					return false;
				});
