...
namespace Game
{
	...
	{
		// Token: 0x06001A49 RID: 6729 RVA: 0x000CD088 File Offset: 0x000CB288
		public ChestWidget(IInventory inventory, ComponentChest componentChest)
		{
			this.m_componentChest = componentChest;
			XElement node = ContentManager.Get<XElement>("Widgets/ChestWidget", null);
		...
		// Token: 0x06001A4A RID: 6730 RVA: 0x000CD1BF File Offset: 0x000CB3BF
