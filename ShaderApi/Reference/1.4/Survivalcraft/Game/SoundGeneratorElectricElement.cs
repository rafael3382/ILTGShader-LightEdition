...
namespace Game
{
	...
	{
		// Token: 0x060016E7 RID: 5863 RVA: 0x000AC7AC File Offset: 0x000AA9AC
		...
		// Token: 0x060016E8 RID: 5864 RVA: 0x000AC948 File Offset: 0x000AAB48
		public override bool Simulate()
		{
			...
			{
				this.m_playAllowedTime = base.SubsystemElectricity.SubsystemTime.GameTime + 0.079999998211860657;
				...
				{
					float num6 = 130.8125f * MathUtils.Pow(1.05946314f, (float)(num + 12 * num3));
					int num7 = 0;
