...
namespace Game
{
	...
	{
		// Token: 0x0600150E RID: 5390 RVA: 0x0009F47C File Offset: 0x0009D67C
		public GameMenuDialog(ComponentPlayer componentPlayer)
		{
			XElement node = ContentManager.Get<XElement>("Dialogs/GameMenuDialog", null);
			...
			if (!GameMenuDialog.m_increaseDetailDialogShown && PerformanceManager.LongTermAverageFrameTime != null && PerformanceManager.LongTermAverageFrameTime.Value * 1000f < 25f && (SettingsManager.VisibilityRange <= 64 || SettingsManager.ResolutionMode == ResolutionMode.Low))
			{
				...
				DialogsManager.ShowDialog(base.ParentWidget, new MessageDialog(LanguageControl.Get(GameMenuDialog.fName, 1), LanguageControl.Get(GameMenuDialog.fName, 2), LanguageControl.Ok, null, null));
			}
			if (!GameMenuDialog.m_decreaseDetailDialogShown && PerformanceManager.LongTermAverageFrameTime != null && PerformanceManager.LongTermAverageFrameTime.Value * 1000f > 50f && (SettingsManager.VisibilityRange >= 64 || SettingsManager.ResolutionMode == ResolutionMode.High))
			{
				...
				DialogsManager.ShowDialog(base.ParentWidget, new MessageDialog(LanguageControl.Get(GameMenuDialog.fName, 3), LanguageControl.Get(GameMenuDialog.fName, 4), LanguageControl.Ok, null, null));
			}
			...
			BitmapFont bitmapFont2 = LabelWidget.BitmapFont;
			...
			this.AddStat(stackPanelWidget, LanguageControl.Get(GameMenuDialog.fName, 6), LanguageControl.Get(new string[]
			{
				"GameMode",
				subsystemGameInfo.WorldSettings.GameMode.ToString()
			...
			this.AddStat(stackPanelWidget, LanguageControl.Get(GameMenuDialog.fName, 14), string.Format("{0}/{1}", num, 8192), "");
			...
			if (componentPlayer != null)
			{
				...
				{
					this.AddStat(stackPanelWidget, LanguageControl.Get(GameMenuDialog.fName, 30), string.Format(LanguageControl.Get(GameMenuDialog.fName, 32), LanguageControl.Get(new string[]
					{
						"GameMode",
						subsystemGameInfo.WorldSettings.GameMode.ToString()
					})), "");
			...
			if (string.CompareOrdinal(subsystemGameInfo.WorldSettings.OriginalSerializationVersion, "1.29") > 0)
			{
				...
				this.AddStat(stackPanelWidget, LanguageControl.Get(GameMenuDialog.fName, 74), LanguageControl.Get(new string[]
				{
					"GameMode",
					easiestModeUsed.ToString()
				}), "");
		...
		// Token: 0x0600150F RID: 5391 RVA: 0x000A0704 File Offset: 0x0009E904
		public override void Update()
		{
			if (this.Children.Find<ButtonWidget>("More", true).IsClicked)
			{
				...
				if (this.m_adventureRestartExists && GameManager.WorldInfo.WorldSettings.GameMode == GameMode.Adventure)
				{
					...
					{
						DialogsManager.ShowDialog(base.ParentWidget, new MessageDialog(LanguageControl.Get(GameMenuDialog.fName, 83), LanguageControl.Get(GameMenuDialog.fName, 84), LanguageControl.Yes, LanguageControl.No, delegate(MessageDialogButton result)
						{
		...
		// Token: 0x06001510 RID: 5392 RVA: 0x000A096D File Offset: 0x0009EB6D
		public IEnumerable<ActiveExternalContentInfo> GetRateableItems()
		{
			if (GameManager.Project != null && UserManager.ActiveUser != null)
			{
				...
				IEnumerator<ActiveExternalContentInfo> enumerator = null;
			}
			yield break;
			yield break;
		}

		// Token: 0x06001511 RID: 5393 RVA: 0x000A0976 File Offset: 0x0009EB76
		...
		// Token: 0x06001512 RID: 5394 RVA: 0x000A09B0 File Offset: 0x0009EBB0
